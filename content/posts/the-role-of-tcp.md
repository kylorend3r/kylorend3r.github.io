...
* [Describing Idle Connections](#describing-idle-connections)
* [PostgreSQL TCP Keepalive Configurations](#postgresql-tcp-keepalive-configurations)
* [Configuration Example](#configuration-example)
* [Considerations and Best Practices](#considerations-and-best-practices)
* [How to Change TCP Configurations](#how-to-change-tcp-configurations)
* [TCP Configurations and Active Connections](#tcp-configurations-and-active-connections)
* [The Impact of Enabling TCP Keepalive Configurations](#the-impact-of-enabling-tcp-keepalive-configurations)
  * [Possible Advantages of Enabling TCP Keepalives](#possible-advantages-of-enabling-tcp-keepalives)
  * [Possible Disadvantages of Enabling TCP Keepalives](#possible-disadvantages-of-enabling-tcp-keepalives)
  * [Considerations Before Enabling It on PostgreSQL Level](#considerations-before-enabling-it-on-postgresql-level)
* [Tips and Tricks to Work on Idle Connections and Configurations](#tips-and-tricks-to-work-on-idle-connections-and-configurations)
...
{{< figure src="/images/posts/the-role-of-tcp/pg_metrics_2.webp" alt="Memory usage with idle connections" caption="Memory usage increase after creating 250 idle connections" >}}
...
{{< figure src="/images/posts/the-role-of-tcp/pg_metrics_3.webp" alt="Memory usage after terminating connections" caption="Memory usage decrease after terminating idle connections" >}}
...
The following logs will be written to the PostgreSQL log file once the invalid idle connections are terminated:
...
> **PS:** There are different ways to manage and update the PostgreSQL configurations. I tried to use one of the basic ones to illustrate the change.
...
### Query 1: Check Idle Connections
